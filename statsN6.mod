: $Id: stats.mod,v 1.152 2009/01/07 19:35:03 billl Exp $
...
PROCEDURE install () {
  if (INSTALLED==1) {
    printf("$Id: stats.mod,v 1.152 2009/01/07 19:35:03 billl Exp $")
  } else {
  INSTALLED=1
VERBATIM
  x1x=y1y=z1z=0x0;
...
VERBATIM {
  ...
  return *(hoc_objectdata[sym->u.oboff].pval); // is this ._pval safe??
 }
ENDVERBATIM
}
